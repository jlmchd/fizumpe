...
class JogoViewController : UIViewController {
    ...
    // NOVO
    var quantidadePlantasClicadas = 0
    // NOVO
    var tempoDeTela = 20000
    ...
    func fazAcontecer() {
        // NOVO
        // adicionar e apos 3 segundos some planta, enquanto a quantidade clicada for menor do que o desejado
        while(quantidadePlantasClicadas < 3){
    ...
    @objc func somePlantaQuandoClica(_ sender: UIButton) {
        quantidadePlantasClicadas = quantidadePlantasClicadas + 1
        sender.alpha = 0
    }
    ...
    func adicionaPlanta() {
        ...
        numeroDePlantas = numeroDePlantas - 1
